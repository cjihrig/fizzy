...
fizzy::ExecutionResult wasi_return_enosys(fizzy::Instance&, const fizzy::Value*, int64_t&, int)
{
    return fizzy::Value{uint32_t{UVWASI_ENOSYS}};
}

fizzy::ExecutionResult wasi_proc_exit(fizzy::Instance&, const fizzy::Value* args, int64_t&, int)
{
...
fizzy::ExecutionResult wasi_fd_write(
    fizzy::Instance& instance, const fizzy::Value* args, int64_t&, int)
{
