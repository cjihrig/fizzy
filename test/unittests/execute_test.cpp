...
TEST(execute, imported_function)
{
    ...
    */
    ...
    constexpr auto host_foo = [](void*, void*, Instance&, const Value* args,
                                  int) -> ExecutionResult {
...
TEST(execute, imported_two_functions)
{
    ...
    */
    ...
    constexpr auto host_foo1 = [](void*, void*, Instance&, const Value* args,
                                   int) -> ExecutionResult {
        return Value{as_uint32(args[0]) + as_uint32(args[1])};
    };
    constexpr auto host_foo2 = [](void*, void*, Instance&, const Value* args,
                                   int) -> ExecutionResult {
        return Value{as_uint32(args[0]) * as_uint32(args[1])};
    };
...
TEST(execute, imported_function_traps)
{
    ...
    */
    ...
    constexpr auto host_foo = [](void*, void*, Instance&, const Value*, int) { return Trap; };
