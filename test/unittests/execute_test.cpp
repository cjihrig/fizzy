...
TEST(execute, imported_function)
{
    ...
    */
    ...
    constexpr auto host_foo = [](Instance&, const Value* args, int64_t&, int) {
...
TEST(execute, imported_two_functions)
{
    ...
    */
    ...
    constexpr auto host_foo1 = [](Instance&, const Value* args, int64_t&, int) {
        return Value{as_uint32(args[0]) + as_uint32(args[1])};
    };
    constexpr auto host_foo2 = [](Instance&, const Value* args, int64_t&, int) {
        return Value{as_uint32(args[0]) * as_uint32(args[1])};
    };
...
TEST(execute, imported_function_traps)
{
    ...
    */
    ...
    constexpr auto host_foo = [](Instance&, const Value*, int64_t&, int) -> ExecutionResult {
        return Trap;
    };
