...
TEST(capi, resolve_instantiate_functions)
{
    ...
    */
    ...
    FizzyValue arg;
    EXPECT_THAT(fizzy_execute(instance, 0, &arg, 0), CResult(42));
    EXPECT_THAT(fizzy_execute(instance, 1, &arg, 0), CResult(43));
...
TEST(capi, resolve_instantiate_globals)
{
   ...
   */
    ...
    EXPECT_THAT(fizzy_execute(instance, 1, nullptr, 0), CResult(42));
    EXPECT_THAT(fizzy_execute(instance, 2, nullptr, 0), CResult(43));
    EXPECT_THAT(fizzy_execute(instance, 3, nullptr, 0), CResult(44));
    EXPECT_THAT(fizzy_execute(instance, 4, nullptr, 0), CResult(45));
